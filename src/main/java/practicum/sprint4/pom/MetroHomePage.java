...
public class MetroHomePage {
    ...
    public void waitForLoadHomePage() {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(8))
                .until(visibilityOfElementLocated(By.xpath(".//*[text() = 'Театральная']")));
    }
    ...
    public void waitForLoadRoute() {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3))
               // .until(visibilityOfElementLocated(By.xpath(".//span[@class='permalink-container__text']")));
    ...
    public void waitForStationVisibility(String stationName) {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(8))
                .until(visibilityOfElementLocated(By.xpath(".//*[text() = stationName]")));
    }
}